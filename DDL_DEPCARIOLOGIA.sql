CREATE DATABASE gestion_depCardio;
	...
	CREATE TABLE dep_Cardiologia.Cardiologos(
		id_empleado UUID NOT NULL PRIMARY KEY -- PRIMARY KEY REFERENCES empleados.Medicos(id_empleado)
	);
	...
	CREATE TABLE dep_Cardiologia.Prescripciones (
	    id_prescripcion UUID PRIMARY KEY,
	...
	CREATE TABLE dep_Cardiologia.Prescripciones_Medicamentos (
	    id_prescripcion UUID REFERENCES dep_Cardiologia.Prescripciones(id_prescripcion),
	    id_medicamento UUID NOT NULL, -- REFERENCES farmacias.Medicamentos(id_medicamento),
